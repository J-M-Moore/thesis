...
We begin in Sect.~\ref{sec:exp} with a review of our dataset, which combines standard data entering SM PDF fits with the broadest and most up-to-date subset of the Run II LHC top data ever considered. In Sect.~\ref{sec:theory}, we continue to describe the SM theory predictions used for the top quark data given in Sect.~\ref{sec:exp}. In Sect.~\ref{sec:top_theory}, we introduce the SMEFT operators which affect the top processes considered in Sect.~\ref{sec:exp}. We also describe the generation of the SMEFT theory predictions, and how these augment the existing SM theory calculations. In Sect.~\ref{sec:} we present the results of SM PDF fits using the dataset given in Sect.~\ref{sec:exp}. In Sect.~\ref{sec:} we present
...
%
 ...
 dedicated analysis of the double-differential distribution in Sect.~\ref{subsec:cms2d}.
 %
...
%the distributions that we discard here. 
  ...
  for a perfectly consistent dataset. To investigate this further, we performed a weighted fit; however, we find that the $\chi^2$
    ...
    presented in Sect.~\ref{subsec:cms2d}.
...
interactions~\cite{Ellis:2020unq,Ethier:2021bye}~\cite{Aguilar-Saavedra:2018ksv,
...
Sect.~\ref{sec:exp}, whilst in orange, we give in the intervals
...
Figure~\ref{fig:bsmcorr} shows the correlations the between Wilson
...
perfectly consistent dataset made of $n_{\rm dat}=34$.
...
\end{table}
 ...
 quadratic SMEFT corrections in the fit does not improve much the
...
to $\chi^2_{\rm exp+th}/n_{\rm dat}=2.57$ including  SMEFT $\mathcal{O}(\Lambda^{-4})$ corrections.
 ...
 In order to assess what is the effect of the inclusion of the CMS 2D distribution on the other top sector data,
...
At the level of fit of the Wilson coefficients, the quadratic SMEFT
...
analysis. All results can be found on the public web page that
...
In this section we present the main results of this work, namely
...
\centering
  \subfigure{
  \includegraphics[scale=0.5]{smeft_plots/SMEFTpdf_gluon.pdf}
 }
        %
  \subfigure{
    \includegraphics[scale=0.5]{smeft_plots/SMEFTpdf_gluon_unc.pdf}
  }
   \subfigure{
  \includegraphics[scale=0.5]{smeft_plots/SMEFTpdf_sigma.pdf}
 }
        %
  \subfigure{
  \includegraphics[scale=0.5]{smeft_plots/SMEFTpdf_sigma_unc.pdf}
  }
        \caption{
...
as demonstrated in the case of high-mass Drell-Yan~\cite{Greljo:2021kvv}.
...
\caption{
  ...
  considered in this work (in the linear EFT case) between the outcome of the joint SMEFT-PDF determination
